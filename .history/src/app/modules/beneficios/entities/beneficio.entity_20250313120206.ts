...
export class Beneficio {
  ...
  @ApiProperty({ example: 'Udo Dirkschneider', description: 'Nombre Profesional de la Remision' })
  @Column()
  nombre_profesional: string;

  @ApiProperty({ example: '202220022', description: 'Tarjeta Profesional del Auditor del Beneficio' })
  @Column()
  tp_profesional_planta: string;

  @ApiProperty({ example: 'Robert Halford', description: 'Tarjeta Profesional del Auditor' })
  @Column()
  nombre_auditor: string;

  @ApiProperty({ example: '2025-06-15 22:34', description: 'Hora de Inicio de Beneficio' })
  ...
  @ApiProperty({ example: '10', description: 'Guacales' })
  @Column({ type: 'int', default: 0 })
  guacales_vacios: number;

  @ApiProperty({ example: '250', description: 'Guacales' })
  @Column({ type: 'int', default: 0 })
  guacales_usados: number;

  @ApiProperty({ example: '0', description: 'Guacales' })
  @Column({ type: 'int', default: 0 })
  guacal_extra: number;

  @ApiProperty({ example: '2500', description: 'Aves' })
  @Column({ type: 'int', default: 0 })
  aves_remisionadas: number;

  @ApiProperty({ example: '3', description: 'Aves' })
  @Column({ type: 'int', default: 0 })
  aves_en_guacal_extra: number;

  @ApiProperty({ example: '2495', description: 'Aves' })
  @Column({ type: 'int' })
  aves_colgadas: number;

  @ApiProperty({ example: '5', description: 'Aves' })
  @Column({ type: 'int', default: 0 })
  ...
  @ApiProperty({ example: '5500', description: 'Guacales' })
  @Column({ type: 'int', default: 0 })
  peso_1_guacal_vacio: number;

  @ApiProperty({ example: '41000', description: 'Guacales' })
  @Column({ type: 'int', default: 0 })
