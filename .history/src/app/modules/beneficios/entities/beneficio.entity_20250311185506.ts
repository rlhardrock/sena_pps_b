...
export class Beneficio {
  ...
  @ApiProperty({ example: 'Cisgnus-478', description: 'Nombre mas especifico ' })
  @Column()
  linea_aves: string;

  @ApiProperty({ example: 'Mixto', description: 'Nombre mas especifico ' })
  @Column({ type: 'enum', enum: ['Macho', 'Hembra', 'Mixto'] })
  sexo: string;

  @ApiProperty({ example: '35', description: 'Nombre mas especifico ' })
  @Column({ type: 'int' })
  edad: number;

  @ApiProperty({ example: '1950', description: 'Nombre mas especifico ' })
  @Column({ type: 'int' })
